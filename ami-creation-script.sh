...
echo ================================== Info =====================================================
echo "The below script will create CI/CD AMI with Jenkins Installed"
echo -e "===============================================================================================\n\n"
...
function create_ci_cd_ami() {

    echo -e "You have decided to create AMI for CI/CD."

    echo -e "\n\n ====================== Creating CI/CD Node AMI using Packer ========================="
    echo "Checking whether AMI exists"
    CI_CD_AMI_ID=$(aws ec2 describe-images --filters "Name=tag:Name,Values=CI-CD-Server" --query 'Images[*].ImageId' --region $AWS_REGION --profile default --output text)
